    ...
    return (
        <section className='md:max-w-2xl mx-auto'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-3'>
                <Link href='/cash-in' className='flex flex-col justify-center items-center dark:bg-primary-foreground dark:text-white p-2 rounded-md'>
                    <Image src={cashIn} alt='send-money' height={50} width={50} />
                    <h2 className='text-base font-semibold'>Cash In</h2>
                </Link>
                {/* cash out */}
                <Link href='/cash-request' className='flex flex-col justify-center items-center dark:bg-primary-foreground dark:text-white p-2 rounded-md'>
                    <Image src={cashReq} alt='send-money' height={50} width={50} />
                    <h2 className='text-base font-semibold text-center'>Cash Request</h2>
                </Link>
                <Link href='/withdraw-request' className='flex flex-col justify-center items-center dark:bg-primary-foreground dark:text-white p-2 rounded-md' >
                ...
                <Link href='/transaction-history-agent' className='flex flex-col justify-center items-center dark:bg-primary-foreground dark:text-white p-2 rounded-md'>
